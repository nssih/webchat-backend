...
public interface GroupRepository extends JpaRepository<Group, Long> {
    ...
    @Query("SELECT g FROM Group g JOIN FETCH g.owner WHERE g.owner.username = :ownerUsername AND g.needsKeyRotation = true")
    List<Group> findPendingRotationByOwnerUsername(@Param("ownerUsername") String ownerUsername);
}